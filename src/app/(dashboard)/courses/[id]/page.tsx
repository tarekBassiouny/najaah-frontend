...
import { useCloneCourse, useCourse, useDeleteCourse } from "@/features/courses/hooks/use-courses";
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-mono text-gray-900 dark:text-white">{String(course.id)}</span>
              </div>
