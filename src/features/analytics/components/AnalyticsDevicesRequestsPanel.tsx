          ...
          {deviceTrendData.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>
                  {t(
                    "auto.features.analytics.components.analyticsdevicesrequestspanel.deviceRegistrations",
                  )}
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          {extraViewsTrendData.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>
                  {t(
                    "auto.features.analytics.components.analyticsdevicesrequestspanel.extraViewsOverTime",
                  )}
                </CardTitle>
              </CardHeader>
              <CardContent>
